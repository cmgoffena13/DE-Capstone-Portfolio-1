...
@dag(start_date=datetime(2024,1,1), schedule='@daily', catchup=False, default_args=default_args)
def main():
    ...
    start_main >> [trigger_stock_government_trades_dag, trigger_stock_market_close_dag, trigger_stock_market_tickers_dag]

    trigger_stock_government_trades_dag >> wait_for_stock_government_trades_dag
    
    # Grab tickers before market_close
    trigger_stock_market_tickers_dag >> wait_for_stock_market_tickers_dag >> \
        trigger_stock_market_close_dag >> wait_for_stock_market_close_dag

    [wait_for_stock_government_trades_dag, wait_for_stock_market_close_dag, wait_for_stock_market_tickers_dag] >> \
        trigger_dbt_run_dag
