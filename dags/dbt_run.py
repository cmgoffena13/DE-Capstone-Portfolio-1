...
def dbt_run():
    ...
    dbt_deps = BashOperator(
        task_id="dbt_deps", bash_command="dbt deps", cwd=PATH_TO_DBT_PROJECT
    )
    ...
    dbt_run_snapshot = BashOperator(
        task_id="dbt_run_snapshot", bash_command="dbt snapshot", cwd=PATH_TO_DBT_PROJECT
    )
